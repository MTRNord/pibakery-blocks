...
wget -O ./build/pcre-8.32.tar.gz http://downloads.sourceforge.net/project/pcre/pcre/8.32/pcre-8.32.tar.gz?r=https://sourceforge.net/projects/pcre/files/pcre/8.32/&ts=1470431894&use_mirror=netcologne
